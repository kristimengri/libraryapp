...
public class BaseRepository {
  ...
  public <T extends Base> void addBasePredicate(
    ...
    if (baseFilter.getSoftDeleteStart() != null) {
      preds.add(cb.greaterThanOrEqualTo(r.get(Base_.softDelete), baseFilter.getSoftDeleteStart()));
    }
    if (baseFilter.getSoftDeleteEnd() != null) {
      preds.add(cb.lessThanOrEqualTo(r.get(Base_.softDelete), baseFilter.getSoftDeleteEnd()));
    }
  }

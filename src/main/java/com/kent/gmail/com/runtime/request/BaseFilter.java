...
public class BaseFilter {
  ...
  private OffsetDateTime softDeleteStart;
  ...
  /**
   * @return softDeleteStart
   */
  public OffsetDateTime getSoftDeleteStart() {
    return this.softDeleteStart;
  }

  /**
   * @param softDeleteStart softDeleteStart to set
   * @return BaseFilter
   */
  public <T extends BaseFilter> T setSoftDeleteStart(OffsetDateTime softDeleteStart) {
    this.softDeleteStart = softDeleteStart;
    return (T) this;
  }
}

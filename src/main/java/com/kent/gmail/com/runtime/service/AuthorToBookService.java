...
import com.kent.gmail.com.runtime.data.AuthorToBookRepository;
...
public class AuthorToBookService {
  ...
  public boolean updateAuthorToBookNoMerge(
    ...
    boolean update = baseService.updateBaseNoMerge(authorToBook, authorToBookCreate);

    if (authorToBookCreate.getMainAuthor() != null
        && (!authorToBookCreate.getMainAuthor().equals(authorToBook.isMainAuthor()))) {
      authorToBook.setMainAuthor(authorToBookCreate.getMainAuthor());
      update = true;
    }

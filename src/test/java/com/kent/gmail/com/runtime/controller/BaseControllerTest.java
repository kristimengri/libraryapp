...
public class BaseControllerTest {
  ...
  public void testBaseCreate() {
    ...
    request.setSoftDelete(OffsetDateTime.now());
  ...
  public void assertBase(BaseCreate request, Base testBase) {
    ...
    if (request.getSoftDelete() != null) {
      Assertions.assertEquals(
          request.getSoftDelete().atZoneSameInstant(ZoneId.systemDefault()),
          testBase.getSoftDelete().atZoneSameInstant(ZoneId.systemDefault()));
    }
  }
